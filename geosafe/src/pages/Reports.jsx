...
function getStatusClass(status) {
  return `report-status-${status.toLowerCase().replace(/\s+/g, "-")}`;
}
...
function Reports() {
  ...
  const verifiedReports = reportData.filter(
    (report) => report.status === "Verified"
  ).length;

  const evidenceCount = reportData.reduce(
    (total, report) => total + report.evidence,
    0
  );
          ...
          <section className="reports-page">
            ...
            <div className="reports-page-header">
              <div>
                ...
                <p>
                  Review observations, evidence and incident reports
            ...
            <div className="reports-metrics-grid">
              ...
              <div className="reports-metric-card">
                ...
                <div>
                  ...
                  <strong>
                    {String(pendingReports).padStart(2, "0")}
                  </strong>
                  <small>awaiting authority review</small>
                </div>
              </div>
              ...
              <div className="reports-metric-card">
                ...
                <div>
                  <span>Verified</span>
                  <strong>
                    {String(verifiedReports).padStart(2, "0")}
                  </strong>
                  <small>validated reports</small>
                </div>
              </div>
              ...
              <div className="reports-metric-card">
                ...
                <div>
                  ...
                  <small>attached to reports</small>
                </div>
              </div>
            </div>
              ...
              <div className="reports-drawer-body">
                <div className="reports-detail-title">
                  ...
                  <div>
                    ...
                    <span>
                      Submitted by {selectedReport.officer}
                    </span>
                  </div>
                </div>
                ...
                <div className="reports-detail-grid">
                  ...
                  <div>
                    ...
                    <strong>{selectedReport.unit}</strong>
                  </div>
                ...
                <div className="reports-evidence-box">
                  <div>
                    ...
                    <div>
                      ...
                      <strong>
                        {selectedReport.evidence} Evidence Items
                      </strong>
                    </div>
                  </div>
                ...
                <div className="reports-location-box">
                  <div>
                    ...
                    <div>
                      ...
                      <strong>{selectedReport.coordinates}</strong>
                    </div>
                  </div>
                ...
                <div className="reports-drawer-actions">
                  <button className="reports-primary-action">
                    <CheckCircle2 size={15} />
                    Verify Report
                  </button>

                  <button className="reports-secondary-action">
                    <FileText size={15} />
                    Add Review
                  </button>
                </div>
            ...
            >
              <div className="reports-modal-header">
                <div>
                  ...
                  <h2>Create Field Report</h2>

                  <p>
                    Submit a new observation from the field.
                  </p>
                </div>
              ...
              >
                ...
                <div className="reports-upload-area">
                  ...
                  <span>
                    Add photographs or supporting field evidence
                  </span>
                ...
                <div className="reports-form-footer">
                  <span>
                    Report will be submitted to the command center.
                  </span>
